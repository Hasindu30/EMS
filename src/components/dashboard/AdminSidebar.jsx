...
const AdminSidebar = () => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 z-50 h-screen bg-gray-900 text-white shadow-md transition-all duration-300 ease-in-out overflow-hidden ${isHovered ? 'w-64' : 'w-20'}`}
